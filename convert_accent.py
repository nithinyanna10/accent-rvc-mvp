...
def main() -> int:
    ...
    parser.add_argument("--protect", type=float, default=0.5, help="Protect unvoiced 0..1 (default: 0.5)")
    parser.add_argument("--f0_up_key", type=int, default=0, help="Pitch shift semitones (default: 0)")
    parser.add_argument("--silence_db", type=float, default=-45.0, help="Silence gate threshold dBFS (default: -45)")
    parser.add_argument("--silence_hang", type=int, default=3, help="Silence gate hangover frames (default: 3)")
